 ...
 */
define('CODEFLAVORS_CLIENT_CODE', '68025a1ffc99f3ebd6dd488219cfeb5e');
define('CODEFLAVORS_UPDATES_URL', 'http://www.codeflavors.com');
	...
	public function on_init(){
		...
		if( is_admin() ){
			...
			$args = array(
				...
				'remote_url' 		=> CODEFLAVORS_UPDATES_URL . '/check-updates/',
				'changelog_url'		=> CODEFLAVORS_UPDATES_URL . '/plugin-details/',				
				'current_version' 	=> FA_VERSION
			);			
			new Codeflavors_Upgrade( $args );
		}		
	}
